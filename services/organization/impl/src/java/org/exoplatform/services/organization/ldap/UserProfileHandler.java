...
import org.exoplatform.services.organization.ldap.UserProfileData;
...
public class UserProfileHandler {
  ...
  private static final String queryFindUserProfileByName =
    "from u in class org.exoplatform.services.organization.ldap.UserProfileData " +
    "where u.userName = ?";
  ...
  public UserProfileHandler(HibernateService service, 
  ...
  protected void createUserProfileEntry(UserProfile up, Session session) throws Exception {
  ...
  public UserProfile findUserProfileByName(String userName) throws Exception {
    ...
    Session session = service_.openSession();
  	...
  	if (up == null){
	  	UserProfileData upd = new UserProfileData(userName);
	  	session.save(upd);
	  	up = findUserProfileByName(userName, session);
  	}
    if(up != null){
