/*
 * $Id: NoSuchWorkspaceException.java,v 1.2 2004/07/24 00:16:21 benjmestrallet Exp $
 *
...
public class NoSuchWorkspaceException extends RepositoryException {
   ...
   * @param s description
   */
  public NoSuchWorkspaceException(String s) {
    super(s);
  }
   ...
   */
  public NoSuchWorkspaceException(String s, Exception e) {
    super(s, e);
  }
}
