/*
 * $Id: ItemNotFoundException.java,v 1.2 2004/07/24 00:16:21 benjmestrallet Exp $
 *
...
/**
 * Exception thrown by methods of <code>{@link Item}</code>, <code>{@link Node}</code>
...
public class ItemNotFoundException extends RepositoryException {
   ...
   */
  public ItemNotFoundException(String s, Exception e) {
    super(s, e);
  }
}
