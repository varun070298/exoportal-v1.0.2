/*
 * $Id: UnsupportedRepositoryOperationException.java,v 1.2 2004/07/24 00:16:21 benjmestrallet Exp $
 *
...
public class UnsupportedRepositoryOperationException extends RepositoryException {
   ...
   * @param s description
   */
  public UnsupportedRepositoryOperationException(String s) {
    super(s);
  }
   ...
   */
  public UnsupportedRepositoryOperationException(String s, Exception e) {
    super(s, e);
  }
}
