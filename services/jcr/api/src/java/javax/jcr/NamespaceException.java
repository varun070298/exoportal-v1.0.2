/*
 * $Id: NamespaceException.java,v 1.2 2004/07/24 00:16:21 benjmestrallet Exp $
 *
...
/**
 * Exception thrown by <code>{@link Ticket#setPrefix(String prefix, String uri)}</code>
...
public class NamespaceException extends RepositoryException {
   ...
   */
  public NamespaceException(String s, Exception e) {
    super(s, e);
  }
}