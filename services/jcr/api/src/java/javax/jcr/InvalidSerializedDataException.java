/*
 * $Id: InvalidSerializedDataException.java,v 1.2 2004/07/24 00:16:21 benjmestrallet Exp $
 *
...
/**
 * Exception thrown by the deserialization methods of <code>Ticket</code>
...
public class InvalidSerializedDataException extends RepositoryException {
   ...
   * @param s description
   */
  public InvalidSerializedDataException(String s) {
    super(s);
  }
   ...
   */
  public InvalidSerializedDataException(String s, Exception e) {
    super(s, e);
  }
}
